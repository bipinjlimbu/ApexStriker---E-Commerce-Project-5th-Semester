...
from .views.profile_view import profile_view, edit_profile_view, resend_verification_email, delete_profile_view, profile_status_toggle_view, approve_vendor_view, reject_vendor_view
...
urlpatterns = [
    ...
    path('report/resolve/<int:report_id>/', resolve_report_view, name='resolve_report'),
    path('report/delete/<int:report_id>/', delete_report_view, name='delete_report'),
]
